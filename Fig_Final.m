...
for i=1:sample
    ...
    for j=1:1:length(SNR)
        ...
        N02=1;%without channel error information
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Optimization GMI
        ...
        [P_noma,pc_noma,pk_noma,GMI_noma,SR_noma]=GMI_NOMA_two_user(Nt,K,H_h,H_h,Pt,M,N02,sigma_e*0);
        [SR_noma,Rs_c_noma,Rs_k_noma]=Cal_Rate(pc_noma,pk_noma,H_h,K,N0);
        RRR_noma_e3(i,j,:)=[SR_noma,Rs_c_noma,Rs_k_noma]'
