...
plot(SNR,mean(RRR_RS(:,:,2).*CCC(:,:,2)./sum(CCC(:,:,:),3)),':>r','LineWidth',2,'MarkerSize',4);
...
plot(SNR,mean(RRR_RS(:,:,1)),'-sr','LineWidth',2,'MarkerSize',8);
plot(SNR,mean(RRR_sdma(:,:,1)),'--ob','LineWidth',2,'MarkerSize',8);
plot(SNR,mean(RRR_noma(:,:,1)),'-.^g','LineWidth',2,'MarkerSize',8);
plot(SNR,mean(RRR_oma(:,:,1)),':dk','LineWidth',2,'MarkerSize',8);
