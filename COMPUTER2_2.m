...
title(['Nt=',num2str(Nt),', M=',num2str(K),', SNR(dB)=',num2str(SNR),', sample=',num2str(sample)])
...
xlabel('\sigma_e^2 ')
ylabel('rate (bits/s/Hz)')
title({['Nt=',num2str(Nt),', M=',num2str(K),', SNR(dB)=',num2str(SNR),', sample=',num2str(sample)], ['Compared with other multiple access strategies']})
...
xlabel('\sigma_e^2 ')
ylabel('rate (bits/s/Hz)')
title({['Nt=',num2str(Nt),', M=',num2str(K),', SNR(dB)=',num2str(SNR),', sample=',num2str(sample)], 'Compared with other precoding vector'})
