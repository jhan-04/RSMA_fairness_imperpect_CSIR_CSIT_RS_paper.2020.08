...
%gam=0;
noma_max=zeros(1,6,4);
noma_max_e3=zeros(1,6,4);
sample=1;
for i=1:sample
    ...
    for j=3:1:length(SNR)
        ...
        %%%%%%NOMA_two user
        [P_noma00(:,i,j),RRR_noma0(i,j,:)]=GMI_NOMA_two_user(Nt,K,H_h,Pt,N0,sigma_e);
        
        [P_noma_e,RRR_noma_e]=GMI_NOMA_two_user(Nt,K,H_h,Pt,N0,sigma_e*0);
